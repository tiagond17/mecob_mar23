# Generated by Django 3.2.16 on 2023-02-25 17:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxa_percentual', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='')),
                ('taxa_de_comissao', models.DecimalField(blank=True, decimal_places=2, default=0.01, max_digits=5, null=True, verbose_name='')),
                ('nome', models.CharField(blank=True, max_length=128, null=True, verbose_name='')),
                ('numero_contrato', models.IntegerField(blank=True, null=True, verbose_name='')),
                ('codigo_parcela', models.IntegerField(blank=True, null=True, verbose_name='')),
